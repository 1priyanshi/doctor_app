...
class Fourth_3 extends StatefulWidget {
  Fourth_3({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Fourth_3State createState() => _Fourth_3State();
}

class _Fourth_3State extends State<Fourth_3> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Dr. A.H. Singh", style: TextStyle(
                            color: Colors.black,
