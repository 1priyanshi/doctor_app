...
class Third_4 extends StatefulWidget {
  Third_4({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Third_4State createState() => _Third_4State();
}

class _Third_4State extends State<Third_4> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Bhagat Hospital", style: TextStyle(
                            color: Colors.black,
