...
import 'package:doctor_app/third.dart';
import 'package:doctor_app/fourth.dart';
import 'package:doctor_app/five.dart';
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Dr. B.K. Aggarval",
                              "Rajendra",
                              "10am- 5:30pm", 0xffF7DFB9, 0XffFAF0DA),
                        ),
                        ...
                        GestureDetector(
                          ...
                          child: _buildFruitCard("Dr. Pradeep", "images/avocado.png","8am - 7pm", 0xffC4D4A3, 0XffE0E8CF),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap: (){
                          ...
                          child: _buildFruitCard("Dr. S.J. Metha", "images/mango.png","2pm- 10pm", 0xffF6E475, 0XffF9EFB0),
                        ),
                      ],
                    ),
                    Spacer(),
                    Column(
                      ...
                      GestureDetector(
                          ...
                          child:_buildFruitCard("Dr. B.M Gupta", "images/papaya.png","3pm- 12pm", 0xffFFC498, 0XffFDDCC1),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                        GestureDetector(
                          onTap: (){
                          ...
                          child:_buildFruitCard("Dr. Sinha", "images/strawberry.png","9am- 5:30pm", 0xffF0AEAF, 0XffF8C6CA),
                        ),
                        SizedBox(height: 2 * SizeConfig.heightMultiplier,),
                      ],
                    )
