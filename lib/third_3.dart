...
class Third_3 extends StatefulWidget {
  Third_3({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Third_3State createState() => _Third_3State();
}

class _Third_3State extends State<Third_3> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Dr. Sharma", style: TextStyle(
                            color: Colors.black,
