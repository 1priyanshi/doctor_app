...
class Fourth_4 extends StatefulWidget {
  Fourth_4({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Fourth_4State createState() => _Fourth_4State();
}

class _Fourth_4State extends State<Fourth_4> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Amarleela Hospital", style: TextStyle(
                            color: Colors.black,
