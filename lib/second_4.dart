...
class Second_4 extends StatefulWidget {
  Second_4({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _Second_4State createState() => _Second_4State();
}

class _Second_4State extends State<Second_4> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("J.K. Hospital", style: TextStyle(
                            color: Colors.black,
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("Appointmemt", style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 2.5 * SizeConfig.textMultiplier,
                                          fontWeight: FontWeight.bold,
                                          fontFamily: 'OpenSans-Bold'
