...
class First_3 extends StatefulWidget {
  First_3({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _First_3State createState() => _First_3State();
}

class _First_3State extends State<First_3> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text("Ameda Hospital", style: TextStyle(
                            color: Colors.black,
